...
{
	private ImageButton _playButton, _exitButton, _optionsButton;
	...
	public MenuPanel(GameFrame frame)
	{
		...
		_optionsButton = new ImageButton(	"images//Buttons//optionsButtonM.png", screenSize.width / 2 - BUTTON_WIDTH / 2,
											...
											frame);
		_exitButton = new ImageButton(	"images//Buttons//exitButtonM.png", screenSize.width / 2 - BUTTON_WIDTH / 2,
										5 * screenSize.height / 8, BUTTON_WIDTH, BUTTON_HEIGHT, ImageButton.MyButtonType.EXIT, frame);
		add(_playButton);
		add(_optionsButton);
		add(_exitButton);
